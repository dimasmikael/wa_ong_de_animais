          ...
          child: GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                PageRouteBuilder(
                  pageBuilder: (context, a, b) => DetalhesGatoPage(gato: gato),
                ),
              );
            },
            child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: gato?.lifeSpan == null || gato?.lifeSpan == ""
                              ? SizedBox()
                              : textoListagemVidaUtilPet(gato?.lifeSpan ?? ""),
                        ),
                        const SizedBox(
                          height: 8,
                        ),
