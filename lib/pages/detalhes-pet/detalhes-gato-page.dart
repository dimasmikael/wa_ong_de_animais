...
class DetalhesGatoPage extends StatefulWidget {
  const DetalhesGatoPage({Key? key, this.gato}) : super(key: key);
  final GatoModel? gato;
  @override
  _DetalhesGatoPageState createState() => _DetalhesGatoPageState();
}

class _DetalhesGatoPageState extends State<DetalhesGatoPage> {
  @override
        ...
        children: [
          Expanded(
            child: Stack(
              children: [
                Hero(
                  tag:widget. gato?.image?.url??carregarImagem,
                  child: Container(
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: NetworkImage(widget. gato?.image?.url??carregarImagem,),
                        fit: BoxFit.cover,
                      ),
